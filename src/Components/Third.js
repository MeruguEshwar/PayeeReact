    ...
    return (
        <div>
                    ...
                    <div class="collapse multi-collapse" id="multiCollapseExample1">
                        ...
                        >
                            <div class="card card-body">
                                ...
                                <a className="mt-5 ms-2 cardparagraph text-decoration-none" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample"><i class='fas fa-plus-circle me-3' style={{ fontSize: "22px" }}></i>Add debit or credit card</a>
            ...
            <div class="collapse" id="collapseExample">
                <div
                    class="card"
                    style={{ height: "34rem", width: "400px", marginLeft: "700px", marginTop: "-500px" }}
                >
                    <div class="card card-body">
                        <form class="row g-3">
