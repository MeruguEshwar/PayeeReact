...
function Sixth() {
    return (
        <div>
                    ...
                    <div class="collapse multi-collapse" id="multiCollapseExample1">
                        ...
                        >
                            <div class="card card-body" >
                                ...
                                <div class="card mt-2" style={{ height: "7rem" }} id="cardNumberhover">
                                    <div class="card-body">
                                        <form class="row g-3">
                                            <div class="col-md-10">
            ...
            <div
                class="card"
                style={{ height: "35rem", width: "400px", marginLeft: "1125px", marginTop: "-560px" }}
            >
                <div class="card card-body">
                    <form class="row g-3">
                        <h6 class="card-title ms-1 mb-2">Enter Card Verification Code</h6>
                        ...
                        <div class="col-md-12">
                            <input type="password" placeholder="1213 3216 3216 3216" class="form-control" id="inputPassword4" />
                        </div>
